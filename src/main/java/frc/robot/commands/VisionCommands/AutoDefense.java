...
public class AutoDefense extends CommandBase {
  ...
  public AutoDefense(AtomicReference <Double> xSteering) {
  ...
  public AutoDefense(double speed, AtomicReference <Double> xSteering, double whenToStop) {

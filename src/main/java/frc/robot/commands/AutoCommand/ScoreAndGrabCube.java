...
public class ScoreAndGrabCube extends SequentialCommandGroup {
  /** Creates a new ScoreAndGrabCube. */
  public ScoreAndGrabCube() {
    ...
    addCommands(new TurnArmScore(),
      ...
      new AutoPickup(RobotContainer.mDrivetrain.distanceFromCargoInFeet(), RobotContainer.xDistanceGamePiece),
      new ResetClaw(),
      new ClawForCone(),
      new ArmHomePos());
  }
